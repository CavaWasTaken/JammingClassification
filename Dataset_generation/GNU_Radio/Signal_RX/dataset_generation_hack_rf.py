...
class dataset_generation_hack_rf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dataset_generation_hack_rf")
        ...
        self.recording_type = recording_type = 'CLEAN'
        self.root_dir = root_dir = '/home/cavallinux/Backup/Magistrale/Navigation-Monitoring/NMon_Dataset_10MHz'
        self.filename = filename = 'LINKS_L1_10Mhz_complex_float32_' + time_stamp  + '_' + recording_type
        self.samp_rate = samp_rate = 10e6
        self.rx_gain = rx_gain = 60
        self.full_filename = full_filename = os.path.join(root_dir, filename)
        ...
        self._rx_gain_range = qtgui.Range(0, 62, 1, 60, 200)
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, full_filename, False)
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.qtgui_histogram_sink_x_0_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_complex_to_float_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_file_sink_0_0_0, 0))
    ...
    def set_time_stamp(self, time_stamp):
        ...
        self.set_filename('LINKS_L1_10Mhz_complex_float32_' + self.time_stamp  + '_' + self.recording_type)

    def get_recording_type(self):
        return self.recording_type

    def set_recording_type(self, recording_type):
    ...
    def set_root_dir(self, root_dir):
        ...
        self.set_full_filename(os.path.join(self.root_dir, self.filename))
...
def main(top_block_cls=dataset_generation_hack_rf, options=None):
